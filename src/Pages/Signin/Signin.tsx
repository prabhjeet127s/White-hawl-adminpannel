...
const Signin = () => {
    ...
    return (
        <div className='flex h-screen '>{/*left box*/}
            ...
            <div className='   rounded-4xl h-full  pt-26 w-[40%] ' >  {/*right box*/}

                <div className='  flex  justify-center w-full  ' >
                    <div className='flex flex-col  items-center w-auto    font-semibold mt-10 p-14  ' >
                        <img src='/Logo.png' className='h-40 w-60  text-4xl p-2  ' alt="" />
                        ...
                        <div>
                            <form action="" onSubmit={handleLogin} className='p-4'  >
                                <div className='flex flex-col w-xl  gap-2 p-2 ' >
                                ...
                                <div className=' rounded-xl   w-full m-6 text-center p-2' >
                                    <button className='text-white  w-60 rounded-lg p-4 text-2xl shadow-2xl bg-red-700  hover:opacity-85 '  >Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
